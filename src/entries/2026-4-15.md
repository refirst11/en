---
title: A heartfelt account of the background behind the creation of Plumeria
date: '2026-04/15'
---
...
This is not just a differentiation from StyleX alone, but also from CSS Modules and vanilla-extract and Linaria, which use CSS Modules internally. (See: [Why CSS Modules are not Zero-Runtime](https://zenn.dev/refirst11/articles/5eebe84a64faf5))
...
Having the compiler handle these was not easy, but it worked.
